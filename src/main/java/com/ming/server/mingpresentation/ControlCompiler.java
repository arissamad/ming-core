package com.ming.server.mingpresentation;
...
public class ControlCompiler {
	...
	protected void compile() {
		...
		processBootstrap();
		processMingPresentationFramework();
	...
	protected void processBootstrap() {
		...
		InputStream is = classLoader.getResourceAsStream("mingpresentation/ming-bootstrap.js");
		try {
	...
	protected void processMingPresentationFramework() {
		addFile(jsFiles, "mingpresentation/ClassUtilStatic.js");
		addFile(jsFiles, "mingpresentation/Widget.js");
		addFile(jsFiles, "mingpresentation/Settings.js");
		addFile(jsFiles, "mingpresentation/JQueryPlugins.js");
	}
